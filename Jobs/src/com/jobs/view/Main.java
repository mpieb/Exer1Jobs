...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		controller.createVolunteer("Juan Volunteer", "Direccion molona 4", "614266666", "És voluntari, no cobra");
		controller.createManagerEmployee("Pedro Manager", "Direccion molona 2", "665226666", 80.0);
